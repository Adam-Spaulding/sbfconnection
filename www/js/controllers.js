  ...
  $scope.onSocialSharing = function (imgPath) {
    var options = {
     ...
     var onSuccess = function(result) {
       ...
       console.log("Shared to app: " + result.app); // On Android result.app is currently empty. On iOS it's em
     }
     var onError = function(msg) {
       console.log("Share failed? " + msg); // On Android apps mostly return false even while it's true
     }
...
app.controller('PhotoEditorCtrl', function ($scope, $ionicPlatform) {
      // $scope.launchEditor = function () {
      //    var imageURI =document.getElementById('target-image').src;
      //    openEditor(imageURI);
      // }
      ...
      //     permissions.hasPermisision(permissions.CAMERA, function(status)) {
      //       if (status.hasPermisision) {
      ...
      //   var onSuccess = function(result) {
      //          console.log("Share completed? " + result.completed);  // On Android apps mostly return false even while it's true
      //          document.getElementById('target-image').src = result; // On Android result.app is currently empty. On iOS it's em
      //   }
      //   var onError = function(msg) {
      //          console.log("Share failed? " + msg); // On Android apps mostly return false even while it's true
      //   }
      //   CSDKImageEditor.edit(onSuccess, onError, imageURI, options);
      // }
})
